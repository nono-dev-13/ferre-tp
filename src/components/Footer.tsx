...
function Footer() {
  ...
  return (
    <footer className="fixed-bottom left-0 w-full bg-primary text-primary-foreground p-4 text-center">
      ...
      <p>FERRE TP entreprise de travaux public au capital de 44 000 €. N° TVA : FR 53 453 388 134. Siret : 453 388 134</p>
      {showLegalLink && <Link href="/legal-mentions" className="underline">Mentions Légales</Link>}
    </footer>
  );
}
